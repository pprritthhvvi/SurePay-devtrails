  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={{ paddingBottom: 30 }}>
      ...
      <View style={styles.hero}>
        ...
        <Text style={styles.heroTitle}>SurePay Shield</Text>
      ...
      <Text style={styles.disclaimer}>
        By purchasing, you agree to SurePay Terms of Service. Payouts are subject
