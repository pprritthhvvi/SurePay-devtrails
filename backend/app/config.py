...
class Settings(BaseSettings):
    ...
    # Application Info
    APP_NAME: str = "SurePay"
    APP_VERSION: str = "0.1.0"
    APP_DESCRIPTION: str = "AI-Powered Parametric Insurance Platform for SurePay Workers"
    ...
    DATABASE_URL: str = "sqlite+aiosqlite:///./surepay.db"
